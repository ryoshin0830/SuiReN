...
- **複数画像**: 一つの読み物に複数の画像を任意の位置に配置可能

### 画像配置システム
- **プレースホルダー記法**: `{{IMAGE:画像ID}}` で読み物内任意位置に配置
- **管理画面統合**: ドラッグ&ドロップでアップロード、ワンクリックで読み物挿入
